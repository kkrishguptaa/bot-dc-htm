/* eslint-disable */
import { Collection, EmbedBuilder, type GuildMember as DiscordGuildMember, type Guild, type User } from 'discord.js'
import { type Prisma, type Member as DatabaseGuildMember } from '@prisma/client'
...
const guildWalletsManagers = new Collection<Guild, GuildWalletsManager>()
...
export class GuildWalletManager {
  ...
  private readonly _discord: DiscordGuildMember
