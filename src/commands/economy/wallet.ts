...
import { type Command, type PieceContext } from '@sapphire/framework'
import { ApplicationCommandType, EmbedBuilder, type GuildMember } from 'discord.js'
      ...
      subcommands: [
        ...
        },
        {
          ...
          async messageRun (message, args) {
            ...
            return await dm.send(`Task accomplised ${member.displayName} now has ${currentWallet?.money}`)
          }
        },
        {
          name: 'remove',
